...
Also structured logs will be available in the [logs folder]( src/app/core/logs )
...
Database is the main point of truth, you can check out schemas, constraints and triggers in the [migration](src/app/migrations/versions/555d2a91c348_init_db.py).
...
The api and error handlers are in the [api_folder](src/app/presentation/v1/department).

DTOs are in the [schemas](src/app/schemas), models are set up in the [models](src/app/models)
